"""n=8 pilot (fly_shear_multiseed.py) crossed the gate (delta=0.906,
p=0.00109). Extends to n=30 with 22 new seeds (8-29), combined with 0-7.
"""
...
def main():
    ...
    log_path = "C:/projeler/fly_op/results/fly_shear_seeds8to29.jsonl"
    results = {"real": [], "null": []}
    ...
    orig = [json.loads(l) for l in open("C:/projeler/fly_op/results/fly_shear_multiseed.jsonl", encoding="utf-8")]
    ...
    print("\n=== SONUC (kiris kesme gerilmesi, n=30) ===")
    ...
    with open("C:/projeler/fly_op/results/fly_shear_official30_summary.json", "w", encoding="utf-8") as f:
    ...
    print("wrote results/fly_shear_official30_summary.json")

"""n=8 pilot (fly_deflection_multiseed.py) crossed the gate with a
PERFECT separation (delta=1.000, p=0.000155). Extends to n=30 with 22
new seeds (8-29), combined with 0-7.
"""
...
def main():
    ...
    log_path = "C:/projeler/fly_op/results/fly_deflection_seeds8to29.jsonl"
    results = {"real": [], "null": []}
    ...
    orig = [json.loads(l) for l in open("C:/projeler/fly_op/results/fly_deflection_multiseed.jsonl", encoding="utf-8")]
    ...
    with open("C:/projeler/fly_op/results/fly_deflection_official30_summary.json", "w", encoding="utf-8") as f:
    ...
    print("wrote results/fly_deflection_official30_summary.json")

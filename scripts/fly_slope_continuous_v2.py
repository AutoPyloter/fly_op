...
def main():
    ...
    log_path = "C:/projeler/fly_op/results/fly_slope_continuous_v2_multiseed.jsonl"
    ...
    with open(log_path, "w", encoding="utf-8") as f:
        for seed in SEEDS:
            ...
            for name, sub in [("real_connectome", sub_real), ("er_null", sub_null)]:
                ...
                train_slope_continuous(brain, n_problems=10, n_episodes_per_problem=5, epochs=EPOCHS, lr=LR, seed=seed, verbose_every=50)
    ...
    with open("C:/projeler/fly_op/results/fly_slope_continuous_v2_summary.json", "w", encoding="utf-8") as f:
        json.dump({"real": real.tolist(), "null": null.tolist(), "wilcoxon_p": float(pvalue), "cliffs_delta": cliffs_delta}, f, indent=2)
    print("wrote results/fly_slope_continuous_v2_summary.json")

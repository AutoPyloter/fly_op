"""n=8 pilot (fly_vessel_design_recalibrated_multiseed.py, POST-
recalibration -- see benchmarks_vessel.py and EXPERIMENTS.md 2026-09-24)
crossed the gate with a PERFECT separation (delta=1.000, p=0.000155).
...
def main():
    ...
    log_path = "C:/projeler/fly_op/results/fly_vessel_design_recalibrated_seeds8to29.jsonl"
    results = {"real": [], "null": []}
    ...
    orig = [json.loads(l) for l in open("C:/projeler/fly_op/results/fly_vessel_design_recalibrated_multiseed.jsonl", encoding="utf-8")]
    ...
    print("\n=== SONUC (basincli kap, yeniden kalibre, n=30) ===")
    ...
    with open("C:/projeler/fly_op/results/fly_vessel_design_recalibrated_official30_summary.json", "w", encoding="utf-8") as f:
    ...
    print("wrote results/fly_vessel_design_recalibrated_official30_summary.json")

...
This is the direct test: `scale_free_null` (graph_builders.py) samples a
...
def main():
    ...
    log_path = "C:/projeler/fly_op/results/fly_slope_stability_scalefree_multiseed.jsonl"
    ...
    null = np.array(results["scale_free_null"])
    ...
    print("\n=== SONUC (sev stabilitesi, sentetik hub-baskin (scale-free) null, n=8 tohum) ===")
    ...
    with open("C:/projeler/fly_op/results/fly_slope_stability_scalefree_summary.json", "w", encoding="utf-8") as f:
    ...
    print("wrote results/fly_slope_stability_scalefree_summary.json")

...
def main():
    ...
    log_path = "C:/projeler/fly_op/results/fly_cx_modulated_multiseed.jsonl"
    ...
    with open("C:/projeler/fly_op/results/fly_cx_modulated_summary.json", "w", encoding="utf-8") as f:
        json.dump({"real": real.tolist(), "null": null.tolist(), "wilcoxon_p": float(pvalue), "cliffs_delta": cliffs_delta}, f, indent=2)
    print("wrote results/fly_cx_modulated_summary.json")

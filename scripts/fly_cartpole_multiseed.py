...
def main():
    ...
    log_path = "C:/projeler/fly_op/results/fly_cartpole_multiseed.jsonl"
    ...
    with open("C:/projeler/fly_op/results/fly_cartpole_summary.json", "w", encoding="utf-8") as f:
        json.dump({"real": real.tolist(), "null": null.tolist(), "wilcoxon_p": float(pvalue), "cliffs_delta": cliffs_delta}, f, indent=2)
    print("wrote results/fly_cartpole_summary.json")

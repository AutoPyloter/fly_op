...
statistically robust advantage at $n=30$ (the sixth, transverse shear,
had its $n{=}30$ confirmation still running at the time of writing this
draft; its $n{=}8$ pilot crossed the gate cleanly, $\delta=0.906$,
$p=0.001$).
...
Beam shear & transverse shear stress & $0.91^{\ast}$ & $0.001^{\ast}$ \\
Beam bending & bending stress & $0.613$ & $\approx 0$ \\
\bottomrule
\end{tabular}
\vspace{2pt}
\\\footnotesize{$^{\ast}$ $n=8$ pilot value; $n=30$ confirmation in

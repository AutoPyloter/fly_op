...
- **Dördüncü bir fiziksel görev:** İstatistiksel gücü artırmak için (şu an 2 PASS / 1 FAIL) yeni bir tek-atışlık mühendislik problemi eklemek, "dar sınıf"ın gerçek sınırlarını daha net çizer.
